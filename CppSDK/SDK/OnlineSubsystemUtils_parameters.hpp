...
static_assert(sizeof(JoinSessionCallbackProxy_JoinSession) == 0x000128, "Wrong size on JoinSessionCallbackProxy_JoinSession");
...
static_assert(offsetof(JoinSessionCallbackProxy_JoinSession, SessionName) == 0x000118, "Member 'JoinSessionCallbackProxy_JoinSession::SessionName' has a wrong offset!");
static_assert(offsetof(JoinSessionCallbackProxy_JoinSession, ReturnValue) == 0x000120, "Member 'JoinSessionCallbackProxy_JoinSession::ReturnValue' has a wrong offset!");
